...
benchmark(
  method: :&,
  caption: '#& with 5M intersecting items',
  cases: {
    ...
    'Array#&'   => [Array(250_000..2_750_000), Array(2_000_000..5_000_000)],
  }
)

benchmark(
  method: :&,
  caption: '#& with 5M sparse items (rare case?)',
  cases: {
    ...
    'Array#&'   => [Array(250_000..2_750_000), (10_000..20_000).to_a + (3_000_000..5_000_000).to_a],
  }
)
...
benchmark(
  ...
  cases: {
    ...
    'Array#&'   => [Array(250_000..2_750_000), Array(3_000_000..5_000_000)],
  }
)
